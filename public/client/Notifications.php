        ...
        <div class="fadein">
            <div style="padding: 0px;">
                <div class="header-container">
                    <div style="padding: 0px;"><span role="img" aria-label="left" class="anticon anticon-left" id="backhistory" style="font-size: 25px; color: rgb(255, 255, 255);">
                        <svg viewBox="64 64 896 896" focusable="false" data-icon="left" width="1em" height="1em" fill="currentColor" aria-hidden="true">
                                <path d="M724 218.3V141c0-6.7-7.7-10.4-12.9-6.3L260.3 486.8a31.86 31.86 0 000 50.3l450.8 352.1c5.3 4.1 12.9.4 12.9-6.3v-77.3c0-4.9-2.3-9.6-6.1-12.6l-360-281 360-281.1c3.8-3 6.1-7.7 6.1-12.6z"></path>
                            </svg></span></div> <span class="ant-typography" style="font-weight: 700; font-size: 20px; color: rgb(255, 255, 255);"><strong>Thông báo</strong>
                        </span>
                    <div></div>
                </div>
   <style>
    ...
    display: flex;justify-content: space-between;}
                ...
                <div style="padding: 5px;">
                  ...
                  $get = $PNH->get_row("SELECT * FROM `dongtien` WHERE `username` = '$username' ");
                  if(empty($get)){ ?>
                    <div class="ant-empty">
                  ...
                  foreach ($PNH->get_list(" SELECT * FROM `dongtien` WHERE `username` = '$username'  ORDER BY id DESC ") as $dongtien) {
                  ?>
                  <div class="ant-noti">
                    <div class="childnoti">
                      <span style="font-weight: 500;">Mã giao dịch</span>
                      <span><?=$dongtien['id'];?></span>
                    </div>
                    <div class="childnoti">
                      <span style="font-weight: 700;"><?php if($dongtien['hanhdong'] == 'Nap'){
                    $char = '+';
                    echo 'Cộng tiền';
                  }else{ 
                    $char = '-';
                    echo 'Trừ tiền';
                      ...
                      <span style="color: green;font-weight: 700;"><?=$char.number_format($dongtien['sotienthaydoi']);?></span>
                    </div>
                    <div class="childnoti">
                      <span>Thời gian GD</span>
                      <span><?=$dongtien['thoigian'];?></span>
                    </div>
                  </div>
                  <hr>
                  <?php } } ?>
