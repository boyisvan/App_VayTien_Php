...
<head>
    ...
    <meta property="og:site_name" content="<?=$PNH->site('tenweb');?>">
    <meta property="article:section" content="<?=$PNH->site('mota');?>">
    <meta property="article:tag" content="<?=$PNH->site('tukhoa');?>">
    <!-- THUÊ CODE WEBSITE THEO YÊU CẦU VUI LÒNG LIÊN HỆ PNH | ZALO:  | FB.COM/ -->
    <!-- Twitter Card data -->
    <meta name="twitter:card" content="<?=$PNH->site('anhbia');?>">
    <meta name="twitter:site" content="CMSNT">
    <meta name="twitter:title" content="<?=$PNH->site('tenweb');?>">
    <meta name="twitter:description" content="<?=$PNH->site('mota');?>">
    <meta name="twitter:creator" content="CMSNT">
    <meta name="twitter:image:src" content="<?=$PNH->site('anhbia');?>">
    <link rel="apple-touch-icon" sizes="180x180" href="<?=$PNH->site('favicon');?>">
    <link rel="icon" type="image/png" sizes="32x32" href="<?=$PNH->site('favicon');?>">
    <link rel="icon" type="image/png" sizes="16x16" href="<?=$PNH->site('favicon');?>">
    <link rel="shortcut icon" type="image/x-icon" href="<?=$PNH->site('favicon');?>">
    ...
    <main class="main" id="top">
        <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" data-navbar-on-scroll="data-navbar-on-scroll">
            <div class="container"><a class="navbar-brand d-flex align-items-center fw-bold fs-2"
                    href="<?=BASE_URL('');?>"><img class="d-inline-block me-3" src="<?=$PNH->site('logo');?>" alt=""
                        width="200px" /></a>
        ...
        <section class="py-8" id="sanpham">
            ...
            <div class="container-lg">
                ...
                <div class="row justify-content-center h-100 pt-7 g-4">
                    <?php foreach($PNH->get_list(" SELECT * FROM `category` WHERE `display` = 'SHOW' LIMIT 6 ") as $row){ ?>
                        ...
                        <div class="card h-100 w-100 shadow rounded-lg p-3 p-md-2 p-lg-3 p-xl-5">
                            <div class="card-body text-center text-md-start">
                                ...
                                <div class="py-3">
                                    ...
                                    <p class="card-text">
                                        <b><?=$PNH->num_rows("SELECT * FROM `dichvu` WHERE `loai` = '".$row['title']."' ");?></b>
                                        <?=lang(126);?></p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-lg-4 order-0 order-sm-0 pe-6"><a class="text-decoration-none" href="#"><img
                                class="img-fluid me-2" src="<?=$PNH->site('logo');?>" width="200px" alt="" /></a>
                        <p class="mt-3 text-white"><?=$PNH->site('mota');?></p>
                    </div>
                    ...
                    <div class="col-4 col-md-4 col-lg mb-3 order-1 order-sm-3">
                        ...
                        <div class="fb-page" data-href="<?=$PNH->site('fanpage');?>" data-tabs="timeline"
                            data-width="" data-height="200" data-small-header="false" data-adapt-container-width="false"
                            data-hide-cover="false" data-show-facepile="true">
                            <blockquote cite="<?=$PNH->site('fanpage');?>" class="fb-xfbml-parse-ignore"><a
                                    href="<?=$PNH->site('fanpage');?>">CMSNT.CO</a></blockquote>
                        </div>
                    </div>
                </div>
            </div>
